...
fn test_cartesian2spherical(num_iters: u32) {
    ...
    println!(
        "(cartesian2spherical): Basic loop - num_iters: {} took {:?} microseconds",
        num_iters,
    ...
    println!(
        "(cartesian2spherical): Rayon loop - num_iters: {} took {:?} microseconds",
        num_iters,
        dur.num_microseconds().unwrap()
    );
}
...
fn test_lla2ecef(num_iters: u32) {
    ...
    let mut d1: DateTime<Local> = Local::now();
    for _ in 0..num_iters {
        let ellipsoid = structs::geo_ellipsoid::geo_ellipsoid::new(
            structs::geo_ellipsoid::WGS84_SEMI_MAJOR_AXIS_METERS,
    ...
    let mut dur = d2.signed_duration_since(d1);
    println!(
        "(lla2ecef): Basic loop - num_iters: {} took {:?} microseconds",
        num_iters,
        dur.num_microseconds().unwrap()
    );
    ...
    dur = d2.signed_duration_since(d1);
    println!(
        "(lla2ecef): Rayon loop - num_iters: {} took {:?} microseconds",
        num_iters,
        dur.num_microseconds().unwrap()
    );
}
...
fn test_ll2utm(num_iters: u32) {
    ...
    let mut dur = d2.signed_duration_since(d1);
    println!(
        "(ll2utm): Basic loop - num_iters: {} took {:?} microseconds",
        num_iters,
        dur.num_microseconds().unwrap()
    );
    ...
    dur = d2.signed_duration_since(d1);
    println!(
        "(ll2utm): Rayon loop - num_iters: {} took {:?} microseconds",
        num_iters,
        dur.num_microseconds().unwrap()
    );
}
